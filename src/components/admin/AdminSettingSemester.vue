  ...
  <div>
    <v-card>
      ...
      <table style="position:relative;">
        ...
        <caption>Setting Semester</caption>
        <thead>
          <tr>
        ...
        <tbody>
          <tr v-for="(item, index) in items">
            ...
            <td :data-label="headers[indexSub]" v-for="(sub, indexSub) in item.data" v-if="item.edit" >
              <!-- edit save -->
              <v-text-field v-if="headers[indexSub] != 'id'"
              ...
              <div v-if="headers[indexSub] == 'id'" style="color:purple;">
                Auto
              </div>
            </td>
  ...
  export default {
    ...
    methods: {
      ...
      save (item) {
        ...
        .then(resp => {
          if (resp === true) {
            ...
            this.$axios.post(this.$baseApi + '/setting', post)
            .then(resp => {
              if (resp.data !== null) {
                this.$swal(
                  'Sukses',
        ...
        this.$swal({
          ...
          preConfirm: res => {
            return new Promise((resolve, reject) => {
              this.$axios.delete(this.$baseApi + '/setting/' + item.data[0])
              .then(res => {
      ...
      update (item, index) {
        ...
        .then(resp => {
          if (resp === true) {
            ...
            this.$axios.put(this.$baseApi + '/setting/' + id, put)
            .then(resp => {
              console.log(resp)
              if (resp.data !== null) {
                this.$swal(
      ...
      get (page = false, limit = false) {
        ...
        this.loading = true
        this.$axios.get(this.$baseApi + `/setting`, {params})
        .then(resp => {
          let data = resp.data.setting
